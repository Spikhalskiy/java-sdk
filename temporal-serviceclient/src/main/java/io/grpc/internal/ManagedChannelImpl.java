...
final class ManagedChannelImpl extends ManagedChannel
  ...
  private class RealChannel extends Channel {
    ...
    public <ReqT, RespT> ClientCall<ReqT, RespT> newCall(
      ...
      System.out.println(Thread.currentThread().getName() + " creates PendingCall " + method);
  ...
  private final class LbHelperImpl extends LoadBalancer.Helper {
    ...
    public ManagedChannel createOobChannel(
      ...
      final InternalSubchannel internalSubchannel =
          new InternalSubchannel(
              addressGroup,
              authority,
              userAgent,
    ...
    public void updateOobChannelAddresses(
      ...
      checkArgument(
          channel instanceof OobChannel, "channel must have been returned from createOobChannel");
